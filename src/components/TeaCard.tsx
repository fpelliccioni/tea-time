...
export function TeaCard({ tea, onPick }: Props) {
  ...
  return (
    <button
      onClick={() => onPick(tea)}
      className="group relative w-full text-start bg-tea-900/60 hover:bg-tea-800/70 active:scale-[0.98] border border-tea-700/40 rounded-3xl p-4 transition-all duration-200"
    >
